...
{#if !dismissed}
    ...
    >
      ...
      <div class="mb-3 grid grid-cols-3 gap-2 border-b border-white/[0.08] pb-3">
        {#each [
          { label: 'Speed',   value: vals.speed,   dec: 2 },
          { label: 'Planets', value: vals.planets,  dec: 0 },
          { label: 'Group',   value: vals.group,    dec: 0 },
        ] as stat (stat.label)}
          <div>
      ...
      <div class="grid grid-cols-3 gap-2">
        {#each [
          { label: 'Rot A', value: vals.rotA, dec: 2 },
          { label: 'Rot B', value: vals.rotB, dec: 2 },
          { label: 'Rot C', value: vals.rotC, dec: 2 },
        ] as stat (stat.label)}
          <div>
